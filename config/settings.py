...
S3_SECRET_ACCESS_KEY = env.str("S3_SECRET_ACCESS_KEY", default="minioadmin123")
...
S3_READ_TIMEOUT_SECONDS = env.int("S3_READ_TIMEOUT_SECONDS", default=20)
...
S3_RETRY_MODE = env.str("S3_RETRY_MODE", default="standard")
S3_PRODUCT_IMAGES_ENABLED = env.bool("S3_PRODUCT_IMAGES_ENABLED", default=False)
S3_PRODUCT_IMAGES_PREFIX = env.str("S3_PRODUCT_IMAGES_PREFIX", default="previews")
S3_PRODUCT_IMAGES_PUBLIC_BASE_URL = env.str("S3_PRODUCT_IMAGES_PUBLIC_BASE_URL", default="")
PRODUCT_IMAGE_DELETE_TASK_MAX_RETRIES = env.int("PRODUCT_IMAGE_DELETE_TASK_MAX_RETRIES", default=3)
PRODUCT_ADMIN_SAVE_LOCK_SECONDS = env.int("PRODUCT_ADMIN_SAVE_LOCK_SECONDS", default=120)

# S3 admin files upload
ADMIN_DIRECT_S3_UPLOAD_ENABLED = env.bool("ADMIN_DIRECT_S3_UPLOAD_ENABLED", default=False)
ADMIN_DIRECT_S3_UPLOAD_MAX_BYTES = env.int("ADMIN_DIRECT_S3_UPLOAD_MAX_BYTES", default=524288000)
ADMIN_DIRECT_S3_UPLOAD_PRESIGN_TTL_SECONDS = env.int("ADMIN_DIRECT_S3_UPLOAD_PRESIGN_TTL_SECONDS", default=900)
ADMIN_DIRECT_S3_UPLOAD_ALLOWED_EXTENSIONS = env.str(
...
YANDEX_METRIKA_MEASUREMENT_TOKEN = env.str("YANDEX_METRIKA_MEASUREMENT_TOKEN", default="")
YANDEX_METRIKA_SERVER_EVENTS_ENABLED = env.bool("YANDEX_METRIKA_SERVER_EVENTS_ENABLED", default=False)
...
TELEGRAM_REDIS_URL = env.str("TELEGRAM_REDIS_URL", default=REDIS_URL)
TELEGRAM_OUTBOUND_STREAM = env.str("TELEGRAM_OUTBOUND_STREAM", default="telegram:outbound")
TELEGRAM_OUTBOUND_ACK_STREAM = env.str("TELEGRAM_OUTBOUND_ACK_STREAM", default="telegram:outbound:ack")
TELEGRAM_OUTBOUND_FAILED_STREAM = env.str("TELEGRAM_OUTBOUND_FAILED_STREAM", default="telegram:outbound:failed")
TELEGRAM_OUTBOUND_FEEDBACK_CONSUMER_GROUP = env.str(
    "TELEGRAM_OUTBOUND_FEEDBACK_CONSUMER_GROUP",
    default="django-telegram-feedback",
)
TELEGRAM_OUTBOX_DELIVERING_TIMEOUT_MINUTES = env.int(
    "TELEGRAM_OUTBOX_DELIVERING_TIMEOUT_MINUTES",
    default=30,
)
NOTIFICATION_OUTBOX_PROCESSING_TIMEOUT_MINUTES = env.int(
    "NOTIFICATION_OUTBOX_PROCESSING_TIMEOUT_MINUTES",
    default=15,
)
NOTIFICATION_OUTBOX_MAX_PROCESSING_ATTEMPTS = env.int(
    "NOTIFICATION_OUTBOX_MAX_PROCESSING_ATTEMPTS",
    default=10,
)
SUPPORT_TELEGRAM_URL = env.str("SUPPORT_TELEGRAM_URL", default="https://t.me/palingames_bot")
SUPPORT_INSTAGRAM_URL = env.str("SUPPORT_INSTAGRAM_URL", default="https://www.instagram.com/palingamess/")
...
ORDER_DELIVERY_ALERT_DEDUPE_TTL_SECONDS = env.int("ORDER_DELIVERY_ALERT_DEDUPE_TTL_SECONDS", default=604800)
PRODUCT_SMOKE_CHECK_ALERT_DEDUPE_TTL_SECONDS = env.int(
    "PRODUCT_SMOKE_CHECK_ALERT_DEDUPE_TTL_SECONDS",
    default=604800,
)

INVOICE_PAYMENT_REMINDER_BEFORE_EXPIRY_HOURS = env.float(
    "INVOICE_PAYMENT_REMINDER_BEFORE_EXPIRY_HOURS",
    default=2.5,
)
INVOICE_PAYMENT_REMINDER_MIN_GAP_AFTER_FIRST_EMAIL_HOURS = env.float(
